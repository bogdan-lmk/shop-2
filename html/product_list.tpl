    ...
    <div class="fn_transfer clearfix"> *}
        ...
        <div class="item-card-type">
          {foreach $product->categories as $category}
              {foreach $category->path as $relevantCategory}
        ...
        <form class="fn_variants preview_form" action="/{$lang_link}cart">
            ...
            <div class="button-row">
               <button class="btn btn--white btn-order button buy fn_is_stock{if $product->variant->stock < 1} hidden{/if}" type="submit" onclick="openBasket()"><span data-language="add_to_cart">{$lang->add_to_cart}</span></button>
             </div>
